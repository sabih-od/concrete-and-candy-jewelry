                                ...
                                <form method="POST" action="{{ route('admin.subscription.store') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="limitation" id="product_limit" class="form-control" required>
                                                <option value="limited" @if(old('product_limit') === 'limited') selected @endif>Limited</option>
                                                <option value="unlimited" @if(old('product_limit') === 'unlimited') selected @endif>Unlimited</option>
                                            </select>
                                            @error('limitation')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group col-md-4" id="allowed_products_field">
                                            ...
                                            <input type="number" name="allowed_products" id="allowed_products" class="form-control" value="{{ old('allowed_products') }}" required>
                                        ...
                                        <div class="form-group col-md-4" id="price_per_product_field">
                                            ...
                                            <input type="number" name="price_per_product" id="price_per_product" class="form-control" value="{{ old('price_per_product') }}" required>
                                        </div>

                                        <!-- Total Price field -->
                                        <div class="form-group col-md-4" id="total_price_field">
                                            <label for="total_price">Total Price</label>
                                            <input type="number" name="total_price" id="total_price" class="form-control" value="{{ old('total_price') }}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="expiry_days" id="expiry_days" class="form-control" value="{{ old('expiry_days') }}" required>
                                            @error('expiry_days')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="details" id="details" class="form-control" value="{{ old('details') }}" required>
                                            @error('details')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
